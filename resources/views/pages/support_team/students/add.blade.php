        ...
        <fieldset>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input value="{{ old('name') }}" required type="text" name="name" placeholder="Full Name" class="form-control" id="name">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="email" value="{{ old('email') }}" name="email" class="form-control" placeholder="Email Address" id="email">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="gender">Gender: <span class="text-danger">*</span></label>
                        <select class="custom-select form-control" id="gender" name="gender" required data-fouc data-placeholder="Choose..">
                            <option value=""></option>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        <label>Phone:</label>
                        <input value="{{ old('phone') }}" type="text" name="phone" class="form-control" placeholder="" id="phone">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label>Date of Birth:</label>
                        <input name="dob" value="{{ old('dob') }}" type="text" class="form-control date-pick" placeholder="Select Date..." id="dob">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="nal_id">Nationality: <span class="text-danger">*</span></label>
                        <select data-placeholder="Choose..." required name="nal_id" id="nal_id" class="custom-select form-control">
                            <option value=""></option>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select onchange="getLGA(this.value)" required data-placeholder="Choose.." class="custom-select form-control" name="state_id" id="state_id">
                            <option value=""></option>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select required data-placeholder="Select State First" class="custom-select form-control" name="lga_id" id="lga_id">
                            <option value=""></option>
                        </select>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select class="custom-select form-control" id="bg_id" name="bg_id" data-fouc data-placeholder="Choose..">
                            <option value=""></option>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select onchange="getClassSections(this.value)" data-placeholder="Choose..." required name="my_class_id" id="my_class_id" class="custom-select">
                            <option value=""></option>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select data-placeholder="Select Class First" required name="section_id" id="section_id" class="custom-select">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="adm_no" placeholder="Admission Number" class="form-control" required value="{{ old('adm_no') }}" id="adm_no">
                    </div>
                </div>
            </div>
        </fieldset>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="parent_name" name="parent_name" class="form-control" value="{{ old('parent_name') }}" required>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="parent_phone">Parent's Phone Number:</label>
                        <input type="text" id="parent_phone" name="parent_phone" class="form-control" value="{{ old('parent_phone') }}" required>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="parent_email">Parent's Email:</label>
                        <input type="email" id="parent_email" name="parent_email" class="form-control" value="{{ old('parent_email') }}" required>
                    </div>
                </div>
            </div>
        </fieldset>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <small class="form-text text-muted">Password strength: <span id="password-strength"></span></small>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
