...
<div class="bg-white rounded-lg shadow-sm overflow-hidden">
    <div x-data="{ activeTab: 'manage-students' }">
            ...
            <div class="px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex -mb-px">
                    <button @click="activeTab = 'manage-students'" 
                            ...
                            class="group inline-flex items-center py-4 px-1 border-b-2 font-medium text-sm focus:outline-none transition-colors">
                    ...
                    <button @click="activeTab = 'admit-student'" 
                            ...
                            class="group ml-8 inline-flex items-center py-4 px-1 border-b-2 font-medium text-sm focus:outline-none transition-colors">
                    ...
                    <button @click="activeTab = 'bulk-admit'" 
                            :class="{ 'border-blue-500 text-blue-600': activeTab === 'bulk-admit', 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300': activeTab !== 'bulk-admit' }" 
                            class="group ml-8 inline-flex items-center py-4 px-1 border-b-2 font-medium text-sm focus:outline-none transition-colors">
                        <svg :class="{ 'text-blue-500': activeTab === 'bulk-admit', 'text-gray-400 group-hover:text-gray-500': activeTab !== 'bulk-admit' }" 
                             class="mr-2 h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="relative">
                ...
                <div class="bg-blue-50 rounded-lg p-4 mb-6 flex items-start">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-blue-700">
                            <p>Complete the form below to admit a new student. All fields marked with an asterisk (*) are required.</p>
                        </div>
                    </div>
                </div>
            ...
            <!-- Manage Suspensions Tab Content -->
            <div x-show="activeTab === 'bulk-admit'" 
                 x-transition:enter="transition ease-out duration-300"
                 x-transition:enter-start="opacity-0 transform scale-95"
                 x-transition:enter-end="opacity-100 transform scale-100"
                 x-transition:leave="transition ease-in duration-200"
                ...
                <div class="bg-yellow-50 rounded-lg p-4 mb-6 flex items-start">
                    ...
                    <div class="ml-3">
                        <h3 class="text-sm font-medium text-yellow-800">Suspension Management</h3>
                        <div class="mt-2 text-sm text-yellow-700">
                            <p>This section allows you to manage student suspensions, including viewing current suspensions and reinstating students.</p>
                        </div>
                    </div>
                </div>
