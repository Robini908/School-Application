            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input value="{{ old('address') }}" class="form-control" placeholder="Address" name="address" type="text" required id="address">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input value="{{ old('phone2') }}" type="text" name="phone2" class="form-control" placeholder="" id="phone2">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="adm_no" placeholder="Admission Number" class="form-control" id="adm_no" readonly>
                    </div>
                </div>
            </div>
