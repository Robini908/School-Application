...
<div class="card">
    <div class="card-header bg-white header-elements-inline">
        <h6 class="card-title">Manage and Admit Students</h6>
        {!! Qs::getPanelOptions() !!}
    </div>
    <div class="card-body">
            ...
            <div class="tab-pane fade show active" id="manage-students">
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="card bg-info text-white dashboard-card">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text" id="total-submissions">0</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6">
                                    <div class="card bg-success text-white dashboard-card">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text" id="approved-submissions">0</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6">
                                    <div class="card bg-warning text-white dashboard-card">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text" id="pending-submissions">0</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6">
                                    <div class="card bg-danger text-white dashboard-card">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text" id="disapproved-submissions">0</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4 search-filter-row">
                                <div class="col-lg-4">
                                    <div class="select-card">
                                        <select class="form-control card-select" id="filter-status">
                                ...
                                <tbody id="student-list">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{--<button class="btn btn-sm btn-success btn-mark-approved" data-id="{{ $student->id }}"
                                            {{ $student->action_done ? 'disabled' : '' }} data-toggle="tooltip"
                                            data-placement="top" title="Click to mark as Approved">Approve</button>--}}
                                            @elseif($student->status === 'approved')
                                            <button class="btn btn-sm btn-danger btn-mark-disapproved"
                                                data-id="{{ $student->id }}" data-toggle="modal"
                                                data-target="#disapprovalModal">Disapprove</button>
                                            @elseif($student->status === 'disapproved')
                                            <button class="btn btn-sm btn-info btn-view-details-disapproval"
                                                data-id="{{ $student->id }}" data-toggle="modal"
                                                data-target="#detailsModal">View Disapproval Details</button>
                                            @endif
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="disapprovalModalLabel">Disapprove Admission</h5>
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="disapproval-reason" rows="3"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="disapproval-description">Description:</label>
                                    <textarea class="form-control" id="disapproval-description" rows="3"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="disapproval-attachment">Attach Document:</label>
                                    <input type="file" class="form-control-file" id="disapproval-attachment">
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                <button type="button" class="btn btn-danger" id="save-disapproval-reason">Save
                ...
                <div class="modal fade" id="detailsModal" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="detailsModalLabel">Disapproval Details</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <p><strong>Reason for Disapproval:</strong> <span
                                        id="disapproval-details-reason"></span></p>
                                <p><strong>Description:</strong> <span id="disapproval-details-description"></span></p>
                                <p><strong>Attached Document:</strong> <a id="disapproval-details-attachment" href="#"
