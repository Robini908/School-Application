    ...
    <div class="card col-md-12  p-2 shadow-lg border rounded" style="background: linear-gradient(135deg, #f8f9fa, #e9ecef);">
        ...
        <div class="card-body">
            ...
            <ul class="nav nav-tabs" id="tabLinks" style="border-bottom: 2px solid #dee2e6;">
                <li class="nav-item">
                    <a href="#" class="nav-link active" data-tab="bulk-exam"
                        style="color: #007bff; font-weight: bold; border-bottom: 2px solid #007bff;">
                        Assign Marks Subject-wise
                    </a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" id="moreActionsDropdown" href="#" role="button"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color: #495057;">
                        More Actions
                    </a>
