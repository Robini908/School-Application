                    ...
                    <div class="mr-3">
                        @if ($userPhoto)
                            <a href="{{ route('my_account') }}">
                                <img src="{{ asset('storage/' . $userPhoto) }}" width="38" height="38"
                                    class="rounded-circle" alt="User Photo">
                            </a>
                        @else
                    ...
                    <li
                        ...
                        <ul class="nav nav-group-sub" data-submenu-title="Manage Students">
                            ...
                            @if (Qs::userIsTeamSA())
                                ...
                                <li class="nav-item"><a href="{{ route('students.graduation') }}"
                                        class="nav-link {{ in_array(Route::currentRouteName(), ['students.graduation']) ? 'active' : '' }}">Graduation</a>
                                </li>
