    ...
    <div class="card mb-3">
        ...
        <div class="card-body p-3">
            ...
            <div class="d-flex align-items-center mb-2">
                ...
                <div>
                    <h6 class="text-muted">Class: <span class="font-weight-bold">{{ $selectedStudent->my_class->name
                            }}</span></h6>
                    <h6 class="text-muted">Status: <span class="font-weight-bold">{{ $selectedStudent->status }}</span>
                    </h6>
                    <h6 class="text-muted">Section: <span class="font-weight-bold">{{ $selectedStudent->section->name
                            }}</span></h6>
                    <h6 class="text-muted">Admission No: <span class="font-weight-bold">{{ $selectedStudent->adm_no
                            }}</span></h6>
                </div>
            </div>
            ...
            <div class="row mb-2">
                <div class="col-md-6">
                    <h6 class="text-muted">Parent: <span class="font-weight-bold">{{
                            optional($selectedStudent->parent_detail)->name ?? 'N/A' }}</span></h6>
                    <h6 class="text-muted">Year Admitted: <span class="font-weight-bold">{{
                            $selectedStudent->year_admitted }}</span></h6>
                </div>
                <div class="col-md-6">
                    <h6 class="text-muted">KCPE Score: <span class="font-weight-bold">{{ $selectedStudent->kcpe
                            }}</span></h6>
                    <h6 class="text-muted">Email: <span class="font-weight-bold">{{ $selectedStudent->email }}</span>
                    </h6>
                </div>
            </div>
            ...
            <div class="text-center mb-2">
                ...
                <div class="d-flex justify-content-center align-items-center">
                    ...
                    <div wire:loading wire:target="confirmStudentSuspension">
                        <div class="spinner-border text-danger ms-2" role="status" style="height: 1rem; width: 1rem;">
                        </div>
                    </div>
                ...
                <div class="card card-body bg-light">
                    ...
                    <div class="d-flex justify-content-between mt-2">
                        <div class="d-flex align-items-center">
                            ...
                            <div wire:loading wire:target="cancelApproval" class="spinner-border spinner-border-sm ms-2"
                                role="status"></div>
                        </div>
