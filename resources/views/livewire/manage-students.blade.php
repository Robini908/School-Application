<div class="container">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <p>Are you sure you want to suspend {{ $selectedStudent->name }}?</p>
            <button wire:click="suspendStudent({{ $selectedStudent->id }})" class="btn btn-warning">Suspend</button>
            <button wire:click="cancelSuspend" class="btn btn-secondary">Cancel</button>
        </div>
    </div>
    ...
    <div class="table-responsive" wire:poll.10s="fetchStudents">
        <x-data-table id="studentTable" title="Student List" message="List of registered students"
            ...
            <tr @if($student->is_expelled) style="background-color: #f8d7da;" @endif>
                ...
                <td>
                    <span>
                        ...
                        <span class="badge badge-danger">{{ $student['expulsion_type'] }}</span>
                        @endif
                ...
                <td class="text-center">
                    <div class="list-icons">
                        <div class="dropdown @if($student->is_expelled) bg-light @endif">
                            <button type="button" class="btn btn-link dropdown-toggle" data-toggle="dropdown"
                                aria-expanded="false">
                                <i class="icon-menu9"></i>
                            </button>
                            <ul class="dropdown-menu dropdown-menu-right @if($student->is_expelled) bg-white @endif">
                                <li>
