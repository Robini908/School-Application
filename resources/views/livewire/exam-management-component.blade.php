                ...
                <div>
                    ...
                    @if ($showGradingSystemForm)
                        <div x-show="showInstructions" class="alert alert-info mb-3" x-transition>
                            <strong>Click the "New" button below:</strong><br><br>
                            ...
                            You can also browse existing grading systems below to confirm the existing grading ranges
                            and other
                            parameters.
                        ...
                        <div x-show="!showInstructions" class="mt-3">
                            <div class="alert alert-info mt-2">
                                <strong>View the Instructions:</strong> To manage grading ranges effectively, ensure
                                that the
            ...
            <div class="card">
                <div class="card-body">
                    @if ($gradingSystemDetails)
                        <p><strong>Name:</strong> <span class="text-primary">{{ $gradingSystemDetails->name }}</span>
                        </p>
                    @else
                    ...
                    <h6 class="font-weight-bold mt-4">Grading Ranges for:
                        <span
                            class="text-primary">{{ $selectedSubjectId ? $mySubjects->find($selectedSubjectId)->subject_name : 'Please select a subject' }}</span>
                    </h6>
                    ...
                    <form wire:submit="store" class="mt-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="name" wire:model.live="name"
                                class="form-control form-control-lg" placeholder="Exam Name" />
                            @error('name')
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <select id="class" wire:model.live="selectedClass"
                                        ...
                                        <div class="col-6 col-md-4 col-lg-3 mb-2">
                                            <div class="form-check">
                                                <input type="checkbox" id="section{{ $section->id }}"
                                                    value="{{ $section->id }}" wire:model.live="selectedSections"
                                                    class="form-check-input">
                                                <label class="form-check-label"
                                                    for="section{{ $section->id }}">{{ $section->name }}</label>
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
                                ...
                                <div class="mt-2">
                                    @if ($grading_system_id)
                                        <a href="#" wire:click="viewGradingSystemDetails"
                                            ...
                                            <span>View Details for
                                                {{ $gradingSystems->find($grading_system_id)->name }}</span>
                                        </a>
                                    @endif
                                </div>
                            @else
...
<div class="mb-1" style="background-color: #f8f9fa;">
    <div class="form-row mt-4 mx-2">
        ...
        <div class="col-md-3 mb-3">
            ...
            <input type="text" id="filterName" wire:model.live.debounce.500ms="filterName" class="form-control"
                placeholder="Search by name" />
            <div wire:loading wire:target="filterName" class="text-center my-1"
                style="background-color: #e9ecef; padding: 5px; border-radius: 5px;">
        ...
        <div class="col-md-3 mb-3">
            ...
            <div wire:loading wire:target="filterYear" class="text-center my-1"
                style="background-color: #e9ecef; padding: 5px; border-radius: 5px;">
                <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                <span>Loading...</span>
            </div>
        ...
        <div class="col-md-3 mb-3">
            ...
            <div wire:loading wire:target="filterTerm" class="text-center my-1"
                style="background-color: #e9ecef; padding: 5px; border-radius: 5px;">
                <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                <span>Loading...</span>
            </div>
        ...
        <div class="col-md-3 mb-3">
            ...
            <div wire:loading wire:target="filterGradingSystem" class="text-center my-1"
                style="background-color: #e9ecef; padding: 5px; border-radius: 5px;">
                <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                <span>Loading...</span>
            </div>
        ...
        <div class="d-flex flex-wrap">
            ...
            @if ($filterGradingSystem)
                <span class="badge badge-info m-1">
                    ...
                    <button wire:click="resetFilter('filterGradingSystem')" class="btn-close"
...
<div class="card-body" style="background-color: #f8f9fa;">
    <div class="table-responsive">
        <x-data-table id="examsTable" title="Registered Examinations"
            message="List of registered Examinations in this school" :columns="['Name', 'Term', 'Year', 'Grading System', 'Classes', 'Streams', 'Actions']">
            @if ($exams->count() === 0)
                <tr>
                    <td colspan="7" class="text-center" style="background-color: #e9ecef;">No exams found.</td>
                </tr>
            @else
                @foreach ($exams as $exam)
                    <tr>
                        ...
                        <td>{{ $exam->classes->isNotEmpty() ? $exam->classes->pluck('name')->implode(', ') : 'N/A' }}
                        </td>
                            ...
                            <div class="list-icons">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-left">
                                        ...
                                        <button wire:loading.attr="disabled" wire:loading.class="opacity-50"
                                            wire:target="confirmDelete({{ $exam->id }})"
                                        ...
                                        <button wire:loading.attr="disabled" wire:loading.class="opacity-50"
                                            wire:target="showDetails({{ $exam->id }})"
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary"
                        wire:click="$set('examDetails', [])">Close</button>
...
@if ($isConfirmingDeleting)
    <div class="modal fade show" id="deleteExamModal" tabindex="-1" role="dialog"
        aria-labelledby="deleteExamModalLabel" aria-hidden="true" style="display: block;">
