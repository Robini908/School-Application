                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea id="rules" wire:model.live="rules"
                                class="form-control @error('rules') is-invalid @enderror" rows="5" required></textarea>
                            @error('rules')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-check">
                            ...
                            <div class="form-check mb-1" wire:key="subject-{{ $subject->id }}">
                                <input type="checkbox" class="form-check-input" id="subject-{{ $subject->id }}"
                                    value="{{ $subject->id }}" wire:model.live="selectedSubjects" checked disabled>
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <div class="card shadow-sm rounded-lg p-4 h-100"
                    ...
                    <h4 class="font-weight-bold text-center mb-3" style="color: #007bff;">{{ $gradingSystem->name }}
                    </h4>

                    <!-- Subjects Section -->
                    <section class="border rounded p-3 mb-3" style="background-color: #f1f3f5; border-color: #dcdcdc;">
                        <strong style="color: #333;">Subjects:</strong>
                        <div class="d-flex flex-wrap mt-2">
                            @foreach($gradingSystem->subjects as $subject)
                            <span class="badge bg-info text-white me-3 mb-2" style="font-size: 90%;">{{
                    ...
                    <!-- Effective Date -->
                    <p><strong style="color: #555;">Effective Date:</strong> <span style="color: #007bff;">{{
                            $gradingSystem->effective_date }}</span></p>
