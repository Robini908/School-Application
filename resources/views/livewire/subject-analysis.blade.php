<div class="container mt-4">
    ...
    <div class="mb-3">
        <label for="section" class="form-label">Select Stream(Optional,just for stream analysis)</label>
    ...
    <button wire:click="getGradesCount" class="btn btn-primary">Get Subject Analysis</button>
