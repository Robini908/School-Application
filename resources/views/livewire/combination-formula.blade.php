<div class="card mt-4 col-12 p-3 shadow-lg border rounded" style="background: linear-gradient(135deg, #f8f9fa, #e9ecef);">
    <div class="card-body">
        ...
        <div class="card-header">
            <h5 class="text-success">Exam analysis for classes with subject selection not enabled
            </h5>
        </div>
        <div class="card-body">
            <div class="mb-4">
                    ...
                    <div class="mt-4">
                        ...
                        @if ($hasCaution)
                            ...
                            <div class="alert alert-danger position-sticky"
                                ...
                                <strong
                                    style="font-size: 1.25rem; font-family: 'Roboto', sans-serif;">Important:</strong>
                                We
                                have noticed the grading system
                                '<strong>{{ optional($exams->find($selectedExam)->gradingSystem)->name ?? 'N/A' }}</strong>'
                                has no
                                ranges defined for the subjects. Please ensure the ranges are carefully and fully
                                defined
                                    ...
                                    <table class="table table-bordered" style="width: 100%; border-radius: 5px;">
                                        <thead>
                                            <tr class="table-primary">
                                                ...
                                                <th colspan="{{ count($subjects) }}" class="text-center" style="font-family: 'Roboto', sans-serif;">Subjects</th>
                                                <th rowspan="2" class="align-middle text-center" style="font-family: 'Roboto', sans-serif;">Total Marks</th>
                                                <th rowspan="2" class="align-middle text-center" style="font-family: 'Roboto', sans-serif;">Total Points</th>
                                                <th rowspan="2" class="align-middle text-center" style="font-family: 'Roboto', sans-serif;">Class Position</th>
                                                <th rowspan="2" class="align-middle text-center" style="font-family: 'Roboto', sans-serif;">Stream Position</th>
                                                <th rowspan="2" class="align-middle text-center" style="font-family: 'Roboto', sans-serif;">Mean Score</th>
                                                <th rowspan="2" class="align-middle text-center" style="font-family: 'Roboto', sans-serif;">Mean Grade</th>
                                            </tr>
