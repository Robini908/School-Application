                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button type="button" wire:click="removeCategory({{ $category->id }})"
                                                    ...
                                                    <i class="fas fa-trash-alt"></i> <!-- Trash icon for removal -->
                                                </button>
                                                @endif
                                            </td>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button wire:click="edit({{ $subject->id }})" class="btn btn-link p-0" wire:loading.attr="disabled" data-toggle="tooltip" data-placement="top" title="Edit">
                                    ...
                                    <div wire:loading wire:target="edit({{ $subject->id }})" class="spinner-border spinner-border-sm ms-2" role="status"></div>
                                </button>
                                <button wire:click="delete({{ $subject->id }})" class="btn btn-link p-0 text-danger" wire:loading.attr="disabled" data-toggle="tooltip" data-placement="top" title="Delete">
