                ...
                <div class="mt-4">
                    ...
                    @if ($hasCaution)
                        ...
                        <div class="alert alert-danger position-sticky"
                            ...
                            <strong style="font-size: 1.25rem; font-family: 'Roboto', sans-serif;">Important:</strong>
                            We have noticed that there are many "N/A" values for the grading system
                            '<strong>{{ optional($exams->find($selectedExam)->gradingSystem)->name ?? 'N/A' }}</strong>'.
                            Please ensure that the grading ranges are fully defined for the subjects to improve the
                            exam analysis.
                        </div>
                                    ...
                                    <thead>
                                        <tr class="table-primary">
                                            <th rowspan="2" class="align-middle"
                                                style="font-family: 'Roboto', sans-serif;">Student Name</th>
                                            <th rowspan="2" class="align-middle"
                                                style="font-family: 'Roboto', sans-serif;">Stream</th>
                                    ...
                                    <tbody>
                                        @forelse ($marks as $mark)
                                            <tr>
                                                ...
                                                @foreach ($subjects as $subject)
                                                    @php
                                                        $subjectMark = $mark['marks'][$subject->id] ?? null; // Use null for missing marks
                                                        $gradeData =
                                                            $subjectMark !== null
                                                                ? $this->getGradeData(
                                                                    $subjectMark,
                                                                    $exam->gradingSystem->id,
                                                                    $subject->id,
                                                                )
                                                                : ['grade' => '-', 'points' => '-'];
                                                    @endphp
                                                ...
                                                <td class="align-middle text-center">
                                                    {{ $mark['total_marks'] ?? '-' }}</td>
                                                <td class="align-middle text-center">
                                                    {{ $mark['total_points'] ?? 'N/A' }}</td>
                                                <td class="align-middle text-center">
                                                    {{ $mark['position'] ?? '-' }}</td>
                                                <td class="align-middle text-center">
                                                    {{ $mark['stream_position'] ?? '-' }}</td>
                                                <td class="align-middle text-center">
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="{{ count($subjects) + 8 }}" class="text-center">No
                                                    marks available for this exam.</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                ...
                <thead>
                    <tr class="table-primary">
                        <th rowspan="2" class="align-middle" style="font-family: 'Roboto', sans-serif;">
                            Student Name</th>
                        <th rowspan="2" class="align-middle" style="font-family: 'Roboto', sans-serif;">Stream
                        </th>
                        <th colspan="{{ count($subjects) }}" class="text-center"
                            style="font-family: 'Roboto', sans-serif;">Subjects</th>
                        <th rowspan="2" class="align-middle text-center"
